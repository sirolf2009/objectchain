	...
	def void testPersistence() {
		...
		val blockchain = new BlockChain() => [
			...
			mainBranch = new Branch(genesis, new ArrayList(Arrays.asList(genesis)), new ArrayList(Arrays.asList(new TestState(0)))) => [
				val mutation1 = new Mutation("1", keys)
				...
				val mutation2 = new Mutation("2", keys)
				val mutation3 = new Mutation("3", keys)
				...
				val mutation4 = new Mutation("4", keys)
				val mutation5 = new Mutation("5", keys)
				val mutation6 = new Mutation("6", keys)
				val mutation7 = new Mutation("7", keys)
